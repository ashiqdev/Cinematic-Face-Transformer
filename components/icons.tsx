...
export const UploadIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M3 17.25V21h18v-3.75M3 12.75l3-3m12 3l-3-3" />
  </svg>
);
...
export const WandIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c.252 0 .487.02.718.057l6.878 1.474M9.75 3.104c-.252 0-.487.02-.718.057L2.157 4.577M9.75 15.152v5.714a2.25 2.25 0 00.659 1.591L14.25 21.5M9.75 15.152c-.252 0-.487-.02-.718-.057L2.157 13.62M9.75 15.152c.252 0 .487-.02.718.057l6.878-1.474m0-11.102l-6.878 1.474m6.878-1.474L21.843 4.577m-1.789 9.043l-6.878-1.474" />
    </svg>
);
